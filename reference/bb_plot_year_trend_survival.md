...
- `bb_plot_year_trend_survival(data.frame)`: Plot annual survival
  estimate as trend line for a data frame.

- `bb_plot_year_trend_survival(bboufit_survival)`: Plot annual estimates
  as trend line for a bboufit_survival object.
