...
Predict calves per adult female by year as trend line. Recruitment fit
object provided must be created with `year_trend = TRUE`.

## Usage

``` r
bb_predict_calf_cow_ratio_trend_samples(recruitment)
```
