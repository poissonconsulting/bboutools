...
#'
#' Plots annual calf-cow ratio estimates as trend line with credible limits.
#' @inheritParams params
#' @export
bb_plot_year_trend_calf_cow_ratio <- function(x, ...) {
  UseMethod("bb_plot_year_trend_calf_cow_ratio")
}

#' @describeIn bb_plot_year_trend_calf_cow_ratio Plot annual calf-cow ratio estimate as trend line for a data frame.
#'
#' @export
