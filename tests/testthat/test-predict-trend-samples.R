...
test_that("bb_predict_survival_trend_samples works", {
  predict <- bb_predict_survival_trend_samples(bboutools:::fit_survival_trend)
...
test_that("bb_predict_survival_trend_samples fails if no year trend fit", {
  expect_chk_error(bb_predict_survival_trend_samples(bboutools:::fit_survival))
})
